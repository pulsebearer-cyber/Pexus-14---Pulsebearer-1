...
export default function AccessibilityStatement() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Accessibility Statement | Pexus" description="Our commitment to digital accessibility and ensuring our website is usable by everyone, regardless of ability." canonical="/accessibility-statement" />
