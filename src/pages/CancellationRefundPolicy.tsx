...
export default function CancellationRefundPolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Cancellation & Refund Policy | Pexus" description="Understand our policies regarding cancellations, refunds, and rescheduling for auto services, rentals, and parts." canonical="/cancellation-refund-policy" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] shadow-sm border border-dark/10">
          <div className="prose prose-slate max-w-none text-dark/80">
            ...
            <p className="mb-4">
              The purpose of this Cancellation & Refund Policy is to clearly explain how cancellations and refunds are handled at Pexus. This policy applies to all towing and recovery service requests made through our website, phone, WhatsApp, or any other official communication channels.
            </p>
            ...
            <p className="mb-4">
              Where applicable, certain costs that have already been incurred by Pexus may not be refundable. This typically includes dispatch costs, travel expenses, waiting time, or any supplementary services that were already performed prior to cancellation.
            </p>
            ...
            <p className="mb-4">
              Pexus or our affiliated towing providers reserve the right to cancel or decline a towing request where:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-6">
