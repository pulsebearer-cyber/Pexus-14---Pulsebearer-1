...
export default function ComplaintsPolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Complaints Policy | Pexus" description="Learn how to submit a complaint or feedback, and understand our resolution process for service issues." canonical="/complaints-policy" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] shadow-sm border border-dark/10">
          <div className="prose prose-slate max-w-none text-dark/80">
            ...
            <p className="mb-4">
              At Pexus, we are committed to providing reliable and professional towing services. However, we understand that things may not always go as planned. The purpose of this Complaints Policy is to provide you with a clear, simple, and fair process for raising complaints.
            </p>
            <p className="mb-4">
