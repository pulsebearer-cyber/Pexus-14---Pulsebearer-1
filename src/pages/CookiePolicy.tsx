...
export default function CookiePolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Cookie Policy | Pexus" description="Learn about how we use cookies to improve your browsing experience on the Pexus website." canonical="/cookie-policy" />
