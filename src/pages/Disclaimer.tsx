...
export default function Disclaimer() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Disclaimer | Pexus" description="Read our website disclaimer regarding automotive advice, service limitations, and third-party links." canonical="/disclaimer" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] shadow-sm border border-dark/10">
          <div className="prose prose-slate max-w-none text-dark/80">
            ...
            <p className="mb-4">
              Our website may contain links or connections to third-party services, including WhatsApp, Google Maps (or other mapping services), payment platforms, social media platforms, and external websites. These third-party services operate independently and are governed by their own terms and privacy policies. Pexus assumes no responsibility for their content, accuracy, or functionality.
            </p>
            ...
            <p className="mb-4">
              Information found on this website should not be interpreted as creating guarantees, warranties, or promises beyond those that are expressly agreed upon in writing between the customer and Pexus or the assigned towing provider.
            </p>

            <h2 className="text-2xl font-bold mt-10 mb-4 border-b border-dark/10 pb-2">13. Limitation of Responsibility</h2>
            <p className="mb-4">
              To the maximum extent permitted by applicable Ghanaian law, Pexus shall not be held liable for any direct, indirect, incidental, or consequential damages resulting from circumstances outside our reasonable control. This includes delays, service failures, or issues arising from reliance on website information. This limitation does not attempt to remove responsibilities that cannot be legally excluded under Ghanaian law.
            </p>
