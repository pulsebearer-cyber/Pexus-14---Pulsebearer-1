...
export default function EmergencyServicePolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Emergency Service Policy | Pexus" description="Guidelines and policies regarding our 24/7 emergency towing and roadside assistance operations." canonical="/emergency-service-policy" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] shadow-sm border border-dark/10">
          <div className="prose prose-slate max-w-none text-dark/80">
            ...
            <p className="mb-4">
              This Emergency Service Policy explains how urgent towing requests are handled at Pexus. We consider an emergency or urgent towing request to include situations such as vehicle breakdowns, accident-related towing, vehicles stranded on the roadside, or vehicles that cannot safely continue driving. 
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              To ensure the fastest possible response in an emergency, Pexus may utilize independent towing drivers, partners, or affiliated service providers to reach your location. These independent providers are directly responsible for the safe physical execution of the service.
            </p>
            ...
            <p className="mb-4">
              To the maximum extent permitted under Ghanaian law, Pexus shall not be liable for direct, indirect, incidental, or consequential damages resulting from delays in emergency response, failed service, or circumstances outside our reasonable control. This does not attempt to exclude responsibilities that cannot legally be excluded.
            </p>
            ...
            <div className="bg-slate-50 p-6 rounded-[1px] mt-6 border border-dark/10 flex flex-col sm:flex-row gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:0597684860" className="text-dark/70 hover:text-accent transition-colors">059 768 4860</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:official.pexus@gmail.com" className="text-dark/70 hover:text-accent transition-colors">official.pexus@gmail.com</a>
                </div>
              </div>
            </div>
          </div>
