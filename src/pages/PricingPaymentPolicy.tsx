...
export default function PricingPaymentPolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Pricing & Payment Policy | Pexus" description="Information on our service rates, accepted payment methods, and billing processes for all auto services." canonical="/pricing-payment-policy" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] shadow-sm border border-dark/10">
          <div className="prose prose-slate max-w-none text-dark/80">
            ...
            <p className="mb-4">
              In the event that an agreed towing charge remains unpaid upon completion of the service, Pexus reserves the right to withhold the release of the towed vehicle or pursue the outstanding balance through fair and legally appropriate debt recovery channels under Ghanaian law. 
            </p>
