...
const REPAIR_SERVICES = [
  { icon: ShieldCheck, title: 'Auto Body Works', desc: 'Collision repair, dent removal, and premium oven-baked spray painting to restore your vehicle to factory condition.', href: '/body-works' },
...
const HOW_IT_WORKS = [
  'Contact Us', 'Vehicle Drop-Off', 'Diagnostics', 'Quote Approval', 'Repair Complete', 'Quality Check', 'Ready for Pickup'
];
...
export default function Repairs() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen">
      <SEO title="Professional Auto Repairs & Diagnostics | Pexus" description="Certified mechanics offering comprehensive auto repairs, advanced computer diagnostics, routine maintenance, and engine overhauls." canonical="/repairs" />
      <div className="bg-white border-b border-dark/10 py-4 absolute top-24 lg:top-[104px] left-0 w-full z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumbs items={[{ label: 'Auto Repairs' }]} />
        </div>
      </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <a href="tel:0597684860" className="bg-accent hover:bg-accent/90 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
              <Phone className="w-5 h-5" /> Call for Repair: 0597684860
            </a>
            <a href="https://wa.me/233597684860" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
              <MessageCircle className="w-5 h-5" /> WhatsApp for Repair
            </a>
          </motion.div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-white relative -mt-16 rounded-t-[1px] z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {REPAIR_SERVICES.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white p-6 rounded-[1px] shadow-sm border border-dark/10 hover:shadow-xl transition-all group flex flex-col"
                >
                  ...
                  <div className="mt-auto pt-4 border-t border-dark/10 space-y-2">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      ...
                      <a href="https://wa.me/233597684860" target="_blank" rel="noopener noreferrer" className="flex-1 bg-primary hover:bg-primary/90 text-white text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm flex items-center justify-center gap-1.5 min-h-[40px] rounded-full">
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Why Choose Pexus</h2>
            <p className="text-white/80 text-lg">Quality service, honest advice, and transparent pricing.</p>
          </div>
            ...
            {WHY_CHOOSE_US.map((feature, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white/5 border border-white/10 rounded-[1px] p-6 text-center hover:bg-accent transition-all group"
                >
      ...
      <section className="py-16 md:py-24 bg-white border-y border-dark/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {MAINTENANCE_PACKAGES.map((pkg, idx) => (
              ...
              >
                ...
                <button className={cn(
                  "w-full py-4 rounded-full font-bold transition-all mt-auto",
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl bg-primary rounded-[1px] p-6 sm:p-8 md:p-12 shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Call for an Appointment</h2>
            <p className="text-white/80 mb-8">Contact us today to schedule your repair or maintenance service.</p>
            
            
            <div className="space-y-4">
              <a href="tel:0597684860" className="w-full bg-accent hover:bg-accent/90 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl text-lg flex justify-center items-center gap-2 rounded-full">
                <Phone className="w-5 h-5"/> Call Now: 0597684860
              </a>
              <a href="https://wa.me/233597684860" target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] hover:bg-[#1EBE5D] text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl text-lg flex justify-center items-center gap-2 rounded-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-white/80">State-of-the-art facilities equipped to handle any repair.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4 overflow-x-auto no-scrollbar pb-8 px-4 sm:px-6 lg:px-8 snap-x">
          {[
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: idx * 0.1 }}
              className="w-[85vw] sm:w-[300px] md:w-[450px] aspect-[4/3] shrink-0 rounded-[1px] overflow-hidden snap-center"
            >
            ...
            {REPAIR_FAQS.map((faq, idx) => (
              ...
              >
                <button 
                  ...
                  className="w-full px-6 py-5 text-left flex justify-between items-center hover:bg-dark/5 transition-colors rounded-full"
                >
      ...
      <section className="py-16 md:py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://wa.me/233597684860" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-slate-100 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
              <MessageCircle className="w-5 h-5 text-accent" /> WhatsApp for Repair
            </a>
          </div>
        </div>
      </section>
