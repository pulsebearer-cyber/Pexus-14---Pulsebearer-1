...
export default function ServiceAreaPolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Service Area Policy | Pexus" description="Details on our geographic coverage, response times, and out-of-boundary service terms for towing." canonical="/service-area-policy" />
