...
export default function TermsConditions() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Terms & Conditions | Pexus" description="Review the general terms and conditions for using Pexus and our website." canonical="/terms-conditions" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] shadow-sm border border-dark/10">
          <div className="prose prose-slate max-w-none text-dark/80">
            ...
            <p className="mb-4">
              Welcome to Pexus. By accessing or using our website and requesting our towing or automotive services, you agree to be bound by these Terms & Conditions. If you do not agree with any part of these terms, please do not use our website or services.
            </p>
            ...
            <p className="mb-4">
              All text, images, logos, branding, graphics, and other content on this website are the property of Pexus or our content suppliers. You may not copy, reproduce, distribute, or create derivative works from our content without our express written permission.
            </p>
            ...
            <p className="mb-4">
              To the fullest extent permitted by applicable law, Pexus shall not be liable for any indirect, incidental, special, or consequential damages resulting from your use of our website or services. This limitation applies to circumstances beyond our reasonable control, without unlawfully excluding responsibilities that cannot be legally excluded under Ghanaian law.
            </p>
