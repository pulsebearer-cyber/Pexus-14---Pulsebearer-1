...
export default function TowingServiceTerms() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Towing Service Terms | Pexus" description="Read the specific terms, conditions, and liabilities related to our emergency towing and vehicle recovery services." canonical="/towing-service-terms" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] shadow-sm border border-dark/10">
          <div className="prose prose-slate max-w-none text-dark/80">
            ...
            <p className="mb-4">
              Pexus may connect you with independent towing drivers or affiliated towing providers to fulfill your service request. In such instances, the independent provider is directly responsible for the execution of the tow and adherence to safety standards.
            </p>
