...
export default function VehicleDamageLiabilityPolicy() {
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      <SEO title="Vehicle Damage & Liability Policy | Pexus" description="Understand our liability limits, damage claims process, and insurance coverage during towing or repair services." canonical="/vehicle-damage-liability-policy" />
