...
export default function Accra() {
  return (
    <>
      <SEO 
        title="Towing & Recovery Service in Accra"
        description="Looking for a dependable tow truck in Accra? Pexus has you covered with emergency towing, accident recovery, and roadside support, any time of day or night. Backed by our regional Accra dispatch team, we respond quickly to calls in and around Accra, with the option for long-distance towing when needed. Reach out now for fast, professional service."
        canonical="/service-areas/accra"
        keywords={["towing Accra", "tow truck Accra", "roadside assistance Accra", "car recovery Accra", "emergency towing Accra", "breakdown service Accra"]}
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="mb-12">
            ...
            <div className="mt-8">
              <h1 className="text-3xl md:text-5xl font-bold text-dark mb-4">
                Towing & Recovery Service in Accra
              </h1>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] border border-dark/10 shadow-sm mb-12">
            <p className="text-dark/80 mb-6 leading-relaxed text-lg">
              Looking for a dependable tow truck in Accra? Pexus has you covered with emergency towing, accident recovery, and roadside support, any time of day or night. Backed by our regional Accra dispatch team, we respond quickly to calls in and around Accra, with the option for long-distance towing when needed. Reach out now for fast, professional service.
            </p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-8 border-t border-dark/10">
            ...
            <div className="w-full sm:w-1/2 flex justify-start">
              <Link to="/service-areas/aburi-to-accra" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Aburi to Accra</div>
                </div>
              </Link>
            </div>
            
            <div className="w-full sm:w-1/2 flex justify-end">
              <Link to="/service-areas/accra-to-abuakwa" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full text-right">
                <div className="overflow-hidden">
