...
export default function Adenta() {
  return (
    <>
      <SEO 
        title="Towing & Recovery Service in Adenta"
        description="Stranded in Adenta? Santa Towing & Garage Services provides emergency towing, breakdown recovery, and roadside assistance right here, day or night. Our team, dispatched through our Accra hub, is equipped to handle cars, SUVs, and light commercial vehicles. Licensed, insured, and trusted across Ghana. Contact us today for prompt service in Adenta."
        canonical="/service-areas/adenta"
        keywords={["towing Adenta", "tow truck Adenta", "roadside assistance Adenta", "car recovery Adenta", "emergency towing Adenta", "breakdown service Adenta"]}
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="mb-12">
            ...
            <div className="mt-8">
              <h1 className="text-3xl md:text-5xl font-bold text-dark mb-4">
                Towing & Recovery Service in Adenta
              </h1>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] border border-dark/10 shadow-sm mb-12">
            <p className="text-dark/80 mb-6 leading-relaxed text-lg">
              Stranded in Adenta? Santa Towing & Garage Services provides emergency towing, breakdown recovery, and roadside assistance right here, day or night. Our team, dispatched through our Accra hub, is equipped to handle cars, SUVs, and light commercial vehicles. Licensed, insured, and trusted across Ghana. Contact us today for prompt service in Adenta.
            </p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-8 border-t border-dark/10">
            ...
            <div className="w-full sm:w-1/2 flex justify-start">
              <Link to="/service-areas/achimota" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
            ...
            <div className="w-full sm:w-1/2 flex justify-end">
              <Link to="/service-areas/aflao-to-accra" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full text-right">
                <div className="overflow-hidden">
