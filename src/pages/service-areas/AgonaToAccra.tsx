...
export default function AgonaToAccra() {
  return (
    <>
      <SEO 
        title="Agona to Accra Towing & Vehicle Recovery Service"
        description="Santa Towing & Garage Services handles long-distance towing between Agona and Accra with a licensed, insured, and experienced team. Whether it's a breakdown, accident, or scheduled transport, we get your vehicle safely from Agona to Accra. Call or WhatsApp us now for a quote and fast dispatch."
        canonical="/service-areas/agona-to-accra"
        keywords={["towing Agona to Accra", "Agona Accra towing service", "tow truck Agona", "vehicle recovery Agona Accra", "long distance towing Ghana"]}
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="mb-12">
            ...
            <div className="mt-8">
              <h1 className="text-3xl md:text-5xl font-bold text-dark mb-4">
                Agona to Accra Towing & Vehicle Recovery Service
              </h1>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] border border-dark/10 shadow-sm mb-12">
            <p className="text-dark/80 mb-6 leading-relaxed text-lg">
              Santa Towing & Garage Services handles long-distance towing between Agona and Accra with a licensed, insured, and experienced team. Whether it's a breakdown, accident, or scheduled transport, we get your vehicle safely from Agona to Accra. Call or WhatsApp us now for a quote and fast dispatch.
            </p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-8 border-t border-dark/10">
            ...
            <div className="w-full sm:w-1/2 flex justify-start">
              <Link to="/service-areas/agona-nkwanta-to-accra" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
                ...
                <div className="overflow-hidden">
                  ...
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Agona Nkwanta to Accra</div>
                </div>
              </Link>
            </div>
            
            <div className="w-full sm:w-1/2 flex justify-end">
              <Link to="/service-areas/airport-residential" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full text-right">
                <div className="overflow-hidden">
                  <div className="text-xs text-dark/50 font-bold uppercase tracking-wider mb-0.5">Next Area</div>
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Airport Residential</div>
                </div>
                <div className="w-10 h-10 shrink-0 bg-slate-100 flex items-center justify-center rounded-full group-hover:bg-accent group-hover:text-white transition-colors">
