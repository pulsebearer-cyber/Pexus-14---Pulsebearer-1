...
export default function Osu() {
  return (
    <>
      <SEO 
        title="Towing & Recovery Service in Osu"
        description="Santa Towing & Garage Services offers fast, reliable towing and vehicle recovery in Osu and the surrounding area, available around the clock. Whether it's a breakdown, accident, or flat tyre, our licensed and fully insured team responds quickly, day or night. As part of our Accra-coordinated dispatch network, we also handle long-distance towing to other major towns. Call or WhatsApp us now for immediate roadside assistance in Osu."
        canonical="/service-areas/osu"
        keywords={["towing Osu", "tow truck Osu", "roadside assistance Osu", "car recovery Osu", "emergency towing Osu", "breakdown service Osu"]}
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="mb-12">
            ...
            <div className="mt-8">
              <h1 className="text-3xl md:text-5xl font-bold text-dark mb-4">
                Towing & Recovery Service in Osu
              </h1>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-[1px] border border-dark/10 shadow-sm mb-12">
            <p className="text-dark/80 mb-6 leading-relaxed text-lg">
              Santa Towing & Garage Services offers fast, reliable towing and vehicle recovery in Osu and the surrounding area, available around the clock. Whether it's a breakdown, accident, or flat tyre, our licensed and fully insured team responds quickly, day or night. As part of our Accra-coordinated dispatch network, we also handle long-distance towing to other major towns. Call or WhatsApp us now for immediate roadside assistance in Osu.
            </p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-8 border-t border-dark/10">
            ...
            <div className="w-full sm:w-1/2 flex justify-start">
              <Link to="/service-areas/offinso-to-accra" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full">
            ...
            <div className="w-full sm:w-1/2 flex justify-end">
              <Link to="/service-areas/paga-to-accra" className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-[1px] transition-colors max-w-full text-right">
                <div className="overflow-hidden">
                  <div className="text-xs text-dark/50 font-bold uppercase tracking-wider mb-0.5">Next Area</div>
                  <div className="text-sm font-bold text-dark group-hover:text-accent truncate">Paga to Accra</div>
                </div>
                <div className="w-10 h-10 shrink-0 bg-slate-100 flex items-center justify-center rounded-full group-hover:bg-accent group-hover:text-white transition-colors">
